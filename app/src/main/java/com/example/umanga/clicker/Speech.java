...
//private EditText go;
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       txvResult=(TextView)findViewById(R.id.editText);
//go=(EditText)findViewById(R.id.editText);
        setupDomath();
    }
    private void setupDomath(){
        ...
        b_ok.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                EditText userTextEntry=(EditText)findViewById(R.id.editText);
                ...
                Intent intent=new Intent(Speech.this,Plus.class);
